...
" telescope
nnoremap <Leader>fff :Telescope find_files find_command=fd,-H,--type,file,-E,.git<CR>
nnoremap <expr> <Leader>ffh ":Telescope find_files find_command=fd,-H,--type,file,-E,.git cwd=" . expand('%:p:h') . "<CR>"
